...
func GenerateK8sNamespaceFile(namespace string) error {
	...
	if err := template.WriteTemplate2File(namespaceFilePath, k8sNamespaceTemplate, namespaceData); err != nil {
		return err
	}
...
func GenerateK8sDeploymentFile(tier string, namespace string, cmdDepth ...string) error {
	...
	if err := template.WriteTemplate2File(deploymentFilePath, k8sDeploymentTemplate, deploymentData); err != nil {
		return err
	}
...
func GenerateK8sServiceFile(namespace string, cmdDepth ...string) error {
	...
	if err := template.WriteTemplate2File(serviceFilePath, K8sServiceTemplate, serviceData); err != nil {
		return err
	}
...
func GenerateK8sIngressFile(namespace string, appName string) error {
	...
	if err := template.WriteTemplate2File(ingressFilePath, K8sIngressTemplate, ingressData); err != nil {
		return err
	}
...
func GenerateK8sCronJobFile(namespace string, cmdDepth ...string) error {
	...
	if err := template.WriteTemplate2File(cronJobFilePath, K8sCronJobTemplate, cronJobData); err != nil {
		return err
	}
...
func GenerateK8sPvcFile(namespace string, cmdDepth ...string) error {
	...
	if err := template.WriteTemplate2File(pvcFilePath, k8sPvcTemplate, pvcData); err != nil {
		return err
	}
...
func GenerateK8sConfigMap(namespace string, cmdDepth ...string) error {
	...
	if err := template.WriteTemplate2File(configMapFilePath, k8sConfigMapTemplate, configMapData); err != nil {
		return err
	}
